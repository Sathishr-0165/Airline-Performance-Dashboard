...
Passenger Gender & Nationality Distribution
Common Delay Reasons
Monthly Revenue Trend
Route-wise Revenue
Filters (Slicers): Airline, Class, City, Month
Design: Gradient background (Airline Blue theme), shadowed cards, and clean modern visuals.
...
Insights Delivered
Identified top-performing routes and cities.
...
Fields:
Passenger ID, Gender, Nationality
Booking Date, Departure Date/Time, Arrival Date/Time
